...
export const API_URL = {
    ...
    COGNITO_AUTH : `${REGISTRATION_URL}api/cognito_authentications/user_add_details`,
    COGNITO_TEMP_CODE_FIX : `${REGISTRATION_URL}api/cognito_authentications/user_signup`,
    COGNITO_USER_DATA : `${REGISTRATION_URL}api/cognito_authentications/cognito_user_data`
};
