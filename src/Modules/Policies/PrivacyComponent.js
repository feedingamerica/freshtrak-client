...
const PrivacyComponent = props => {
  ...
  return (
    ...
    Contact Information
     ...
     <p>
     Please send your privacy-related questions, comments, and concerns to us via email at [Insert Email]. 
    </p>
    <h4>
