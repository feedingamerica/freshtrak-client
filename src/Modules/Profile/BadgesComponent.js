       ...
       <ul className="d-flex badges-list">
         <li>
           <div className="badge-icon">
             <img alt="pantryvisitor" src={pantryVisitorImage}/>
           </div>
           <div>Pantry Visitor</div>
         </li>
         <li>
         <div className="badge-icon">
             <img alt="reservation" src={reservationImage}/>
           </div>
           <div>Reservation Newbie</div>
         </li>
         <li>
         <div className="badge-icon">
             <img alt="taskmanager" src={taskManagerImage}/>
           </div>
           <div>Task Manager</div>
         </li>
         <li>
         <div className="badge-icon">
             <img alt="profilecompleter" src={profileCompleterImage}/>
           </div>
           <div>Profile Completer</div>
         </li>
         <li>
         <div className="badge-icon">
             <img alt="volunteer" src={volunteerImage}/>
           </div>
           <div>Volunteer</div>
         </li>
       </ul>
